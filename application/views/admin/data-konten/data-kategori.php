    <style type="text/css">
                ...
                <div class="row">
                        ...
                        <div class="author-widgets-single">
                            <div class="row">
                                ...
                                <a href="<?php echo base_url()?>admin/data-admin/tambah-admin" class="col-lg-3 col-md-3 col-sm-3 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="btn btn-block btn-primary col">Tambah Kategori</div>
                                </a>                                            
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid mt100">
                        <?php for($i = 0; $i < count($data); $i++){ ?>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 element-item mt30 pb" data-category="<?php echo $page ?>">
                                <div class="author-widgets-single res-mg-t-30">
                                    ...
                                    <div class="author-wiget-inner">
                                        <div class="perso-img">
                                            <img src="<?php echo base_url() ?>gambar/<?php echo $page ?>/<?php echo $data[$i]['gambar_header'] ?>" class=" circle-border m-b-md profile" alt="profile">
                                            <img src="<?php echo base_url() ?>gambar/<?php echo $page ?>/<?php echo $data[$i]['gambar'] ?>" class=" circle-border m-b-md profile" alt="profile">
                                        </div>
        ...
        <script type="text/javascript">
            function hapus(nama, id, gambar){
                swal({
                    title: "Hapus <?php echo $page ?> "+nama,
                    ...
                    if (!isConfirm) return;
                    $.ajax({
                        url: "<?php echo base_url()?><?php echo $page ?>/hapus-data",
                        type: "POST",
                        data: {
                            id            : id,
                            jenis         : "<?php echo $page ?>",
