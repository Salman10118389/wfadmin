        ...
        <div class="single-product-tab-area mg-t-15 mg-b-30">
            <div class="container-fluid">
                <form action="<?php echo(base_url())?>admin/tambah-data" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <input type="hidden" name="jenis" id="jenis" value="konten">
                        <input type="hidden" name="kategori" id="kategori" value="slider">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_gambar" readonly>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="single-pro-size">
                                        <h6>Link</h6>
                                        <div class="form-group">
                                            <input type="text" placeholder="Masukan Link" name="link" class="form-control">
                                        </div>
                                    </div>
                                </div>
