            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="author-widgets-single">
                            <div class="row">
                                ...
                                <a href="<?php echo base_url()?>admin/data-user/tambah-user" class="col-lg-3 col-md-3 col-sm-3 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="btn btn-block btn-primary col">Tambah User</div>
                                </a>                                            
                            </div>
                        </div>
                    </div>
                    ...
                    <?php  
                        ...
                        $optional['limit'] = "";
                        $optional['offset'] = "";
                        $data = $this->modeladmin->ambil_data("admin_user",$optional); 
                    ?>
                        ...
                        <?php for($i = 0; $i < count($data); $i++){ ?>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 element-item mt30 pb" data-category="admin">
                                <div class="author-widgets-single res-mg-t-30">
                                    <a href="<?php echo base_url()?>admin/data-user/data-lengkap-user/<?php echo $data[$i]['id'] ?>" class="view">
                                        <i class="fas fa-eye"></i>   
                                    </a>
                                    <a href="<?php echo base_url()?>admin/data-user/edit-user/<?php echo $data[$i]['id'] ?>" class="edit">
                                    ...
                                    <div class="author-wiget-inner">
                                        <div class="perso-img">
                                            <img src="<?php echo base_url() ?>gambar/user/<?php echo $data[$i]['photo'] ?>" class=" circle-border m-b-md profile" alt="profile">
                                        </div>
